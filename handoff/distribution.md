...
| 2026-09-04 | Flux complet recontrôlé avant fusion : découverte, installation, usage | Installation rejouée sur la vraie release (téléchargement, somme de contrôle vérifiée, avertissement `PATH`), archive falsifiée rejetée en code 1 sans rien poser, parcours MCP complet en 1,37 s, PDF/A-3b relu — `factur-x.xml` embarqué, profil `urn:cen.eu:en16931:2017`, IBAN présent |
| 2026-09-04 | Emballage plugin conservé | C'est un canal de distribution : fiche dans le répertoire de plugins Claude Code, skill et déclaration MCP en une installation. Le binaire reste requis — le plugin apporte la découverte, pas l'absence d'installation |
